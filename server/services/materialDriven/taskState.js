...
function normalizeAvatarConfig(input = {}) {
  ...
  return {
    ...
    runningHubPoseNodeId: String(input?.runningHubPoseNodeId || base.runningHubPoseNodeId),
    runningHubPoseFieldName: String(input?.runningHubPoseFieldName || base.runningHubPoseFieldName),
    runningHubOutputNodeId: String(input?.runningHubOutputNodeId || base.runningHubOutputNodeId),
