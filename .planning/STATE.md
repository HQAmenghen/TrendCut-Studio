...
last_updated: "2026-06-02T09:19:49+08:00"
last_activity: 2026-06-02 — Completed quick task: 在新版 UI 面板中恢复数字人形象和声音配置入口
progress:
  percent: 0
---
...
Last activity: 2026-06-02 — Completed quick task: 在新版 UI 面板中恢复数字人形象和声音配置入口
...
| 2026-06-01 | 修复 dashboard 拆分后的液态玻璃样式回归 | `.planning/quick/20260601-fix-dashboard-glass-style-regression/SUMMARY.md` |
| 2026-06-01 | 修复发布信息弹窗账号下拉菜单滚动显示 | `.planning/quick/20260601-fix-publish-dropdown-scroll/SUMMARY.md` |
...
| 2026-06-02 | 在新版 UI 面板中恢复数字人形象和声音配置入口 | `.planning/quick/260602-crg-ui/260602-crg-SUMMARY.md` |
