...
- 监控/抓取来源账号、发帖账号、@handle、平台用户名只用于理解素材来源，绝不是口播主体。口播正文严禁出现账号名、@handle、“账号分享”“博主表示”“某账号称”“发布者说”等来源归因；直接讲视频或采访内容本身。真实出现在视频/采访内容中的人物、机构和受访者姓名必须保留。
- 口播正文严禁出现括号英文注释、翻译夹注或中英双写，例如 “中文（ENGLISH）”。数字人会把括号读出来，因此必须改成自然中文口播；必要英文专名可保留在正文中，但不要放进括号解释。
...
7. 必须移除监控来源账号、@handle、“账号分享”“博主表示”“某账号称”等来源归因；保留视频/采访中真实人物和机构。
8. 必须移除括号英文注释、翻译夹注和中英双写，改成自然中文口播。
9. 只输出严格 JSON，不要解释。
